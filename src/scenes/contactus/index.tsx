		...
		<section id="contactus" className="mx-auto w-5/6 pb-32 pt-24">
			<motion.div onViewportEnter={() => setSelectedPage(SelectedPage.ContactUs)}>
				...
				<motion.div
					...
					<p className="my-5">
						Congue adipiscing risus commodo placerat. Tellus et in feugiat nisl sapien vel rhoncus. Placerat at in enim pellentesque. Nulla adipiscing leo egestas nisi elit risus
				...
				<div className="mt-10 justify-between gap-8 md:flex">
					<motion.div
						...
						<form target="_blank" onSubmit={onSubmit} method="POST" action="https://formsubmit.co/your@mail.com">
							...
							<textarea rows={4} cols={50} className={inputStyles} placeholder="MESSAGE" {...register('message', {required: true, maxLength: 200})} />

							<button type="submit" className="bg-secondary-500 duration mt-5 rounded-lg px-20 py-3 transition duration-500 hover:text-white">
								SUBMIT
							</button>
						</form>
					</motion.div>
					<motion.div
						...
						<div className="md:before:content-evolvetext w-full before:absolute before:-bottom-20 before:-right-0 before:z-[-1]">
							<img alt="img" className="w-full" src={ContactUsPageGraphic} />
						</div>
					</motion.div>
				</div>
			</motion.div>
